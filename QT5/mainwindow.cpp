...
static Gamepad_Thread *gamepad_thread;
    ...
    ui(new Ui::MainWindow)
{
    ...
    gamepad_thread = new Gamepad_Thread();
    qRegisterMetaType<joyinfoex_tag>("joyinfoex_tag");//注册一种信号的参数类型
    connect(gamepad_thread, SIGNAL(JoySignal_row(joyinfoex_tag)), this, SLOT(display_slot_row(joyinfoex_tag)));
...
void MainWindow::display_slot_row(joyinfoex_tag state_row){
    ...
    } else if(0 == select.compare("北通_无线")) {
